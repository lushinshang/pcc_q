...
| REQ-D-001／002／005／006  | `src/contracts/tender.ts`                                       | CONTRACT-T-001～008；SCHEMA-T-001                                    | `npm run test:coverage`                                                      |
| REQ-D-003／004            | parser、quality、baseline、workflow                             | PAR-T-001～008；PIPE-T-001～003；BASE-T-001～006；WF-T-005           | `npm test`                                                                   |
| REQ-S-001／003            | `secureFetch.ts`                                                | SEC-T-001～011                                                       | `npm test`                                                                   |
